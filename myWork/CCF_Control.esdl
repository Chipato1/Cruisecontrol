...
reads CarMessages.v, SMMessages.vTarget, DriverMessages.powerDriver, DriverMessages.CC_On, DriverMessages.brakeDriver
writes CCF_Messages.gaspedal_cc, CCF_Messages.brakepedal_cc {
	...
	public void calc() {
		...
		if (DriverMessages.CC_On) {
			brakepedal_tmp = (switch((switch((((SMMessages.vTarget - CarMessages.v) * 0.01) + ((tmp + (SMMessages.vTarget - CarMessages.v)) * 0.01)) < 0.0)
							case 1 :(((SMMessages.vTarget - CarMessages.v) * 0.01) + ((tmp + (SMMessages.vTarget - CarMessages.v)) * 0.01))
							default : 0.0) < -100.0)
					case 1 :(switch((((SMMessages.vTarget - CarMessages.v) * 0.01) + ((tmp + (SMMessages.vTarget - CarMessages.v)) * 0.01)) < 0.0)
							case 1 :(((SMMessages.vTarget - CarMessages.v) * 0.01) + ((tmp + (SMMessages.vTarget - CarMessages.v)) * 0.01))
							default : 0.0)
					default : -100.0); // Main/calc 4/if-then 1
		} else {
			brakepedal_tmp = DriverMessages.brakeDriver; // Main/calc 4/if-else 1
		} // Main/calc 4
		CCF_Messages.brakepedal_cc = brakepedal_tmp; // Main/calc 5
	}
}